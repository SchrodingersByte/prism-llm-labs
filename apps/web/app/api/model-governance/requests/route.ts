/**
 * GET  /api/model-governance/requests  â€” list approval requests for org
 * POST /api/model-governance/requests  â€” submit an approval request
 */
...
export async function POST(req: NextRequest) {
  ...
  // Filing a model-approval request is a writer action (matches the can_write_org
  // RLS): org-scoped owner/administrator/developer only — read_only cannot request.
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
