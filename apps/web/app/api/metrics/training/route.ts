/**
 * GET /api/metrics/training
 * Training / fine-tune run cost summary (training_cost_summary pipe). Manager-only.
 */
...
import { getTrainingCostSummary } from "@/lib/tinybird/queries";
...
export async function GET(req: NextRequest) {
  ...
  const data = await getTrainingCostSummary(member.org_id, from, to);
